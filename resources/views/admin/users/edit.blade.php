                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <span>To change password you have to enter a value, otherwise leave it blank.</span>
                                <p class="text-danger"></p>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{$user->address}}" type="text" name="address" id="address" class="form-control" placeholder="Address">	
                                <p class="text-danger"></p>
                            </div>
                        </div>								
                    </div>
